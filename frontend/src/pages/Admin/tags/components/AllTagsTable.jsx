...
function AllTagsTable({ className }) {
      ...
      <table className="table">
        ...
        <tbody>
              ...
              >
                ...
                <td>
                  <svg
                    ...
                    height="16"
                    viewBox="0 0 24 24"
                    onClick={() => handleEditClick(tag)} // Handle edit click
                ...
                <td>
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                    onClick={() => handleDeleteClick(tag)} // Handle edit click
                    className="cursor-pointer"
                  >
                    <path
          ...
          {displayTags.length < 10 &&
            !loading &&
            !error &&
            Array.from({ length: 10 - displayTags.length }).map(
              (_, index) => (
                <tr
