...
import { deleteQuoteSequence } from "../../../../redux/slices/adminQuoteSlices"; // Assuming you have a deleteQuote action
import ErrorToast from "../../../../components/Custom/Toasts/ErrorToast";
import { resetError } from "../../../../redux/slices/adminQuoteSlices";

const DeleteQuoteSequenceModal = ({ isOpen, onClose, sequenceId }) => {
  ...
  const handleDelete = async () => {
    try {
      await dispatch(deleteQuoteSequence(sequenceId)).unwrap(); // Dispatch the deleteQuote action
      onClose(); // Close modal after successful deletion
    } catch (err) {
      console.error("Failed to delete quote sequence:", err);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-pageBg-light dark:bg-pageBg-dark w-[400px] px-[20px] pt-[20px] pb-[40px] rounded-lg shadow-lg relative">
        ...
        <p className="text-[1.3rem] text-center mb-6 dark:text-textColor-dark">
          Are you sure you want to delete this quote sequence?
        </p>
...
export default DeleteQuoteSequenceModal;
