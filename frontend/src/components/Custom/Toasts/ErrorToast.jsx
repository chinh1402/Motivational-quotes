  ...
  return (
    <>
      <div
        ...
        } transition-all duration-500 ease-in-out bg-red-400 flex items-center rounded-[12px] text-[#fff] p-[16px] min-w-[max-content] fixed top-10 left-1/2 transform -translate-x-1/2 z-50`}
      >
        <icon>
          <svg
